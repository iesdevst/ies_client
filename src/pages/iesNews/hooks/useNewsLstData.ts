...
import { NEWS_EVENT_CATEGORY_META } from './newsEventCategoryMeta';
import NOEX from '@/assets/imgs/17k_noexam.webp';
import NOEXST from '@/assets/imgs/17k_noexam_str.webp';
import BTHMSN from '@/assets/imgs/bt_hms_news.webp';
import BTHMSNST from '@/assets/imgs/bt_hms_news_str.webp';
import BRSTUN from '@/assets/imgs/cnhs_news.webp';
import BRSTUNST from '@/assets/imgs/cnhs_news_str.webp';
import HNCNDN from '@/assets/imgs/hn_cnd_news.webp';
import HNCNDNST from '@/assets/imgs/hn_cnd_news_str.webp';
import HNTN from '@/assets/imgs/hn_lct_news.webp';
import HNTNST from '@/assets/imgs/hn_lct_news_str.webp';
import KHTS from '@/assets/imgs/khts.webp';
import KHTSST from '@/assets/imgs/khts_str.webp';
import KTDT from '@/assets/imgs/ktdt_nfc.webp';
import KTDTST from '@/assets/imgs/ktdt_nfc_str.webp';
import KTO from '@/assets/imgs/kto_nfc.webp';
import KTOST from '@/assets/imgs/kto_nfc_str.webp';
import LDHNN from '@/assets/imgs/ld_hn_news_page.webp';
import LDHNNST from '@/assets/imgs/ld_hn_news_page_str.webp';
import LDTHN from '@/assets/imgs/ld_thud_news_page.webp';
import LDTHNST from '@/assets/imgs/ld_thud_news_page_str.webp';
import PLN from '@/assets/imgs/pl_thcs_news.webp';
import PLNST from '@/assets/imgs/pl_thcs_news_str.webp';
import TKDH from '@/assets/imgs/tkdh_nfc.webp';
import TKDHST from '@/assets/imgs/tkdh_nfc_str.webp';
import HTDHM from '@/assets/imgs/top_str_htdhm.webp';
import HTDHMST from '@/assets/imgs/top_str_htdhm_str.webp';
import LTS from '@/assets/imgs/top_str_lts.webp';
import LTSST from '@/assets/imgs/top_str_lts_str.webp';
import NBCN from '@/assets/imgs/top_str_news.webp';
import NBCNST from '@/assets/imgs/top_str_news_str.webp';
import TSDT from '@/assets/imgs/tsdt_p1.webp';

import TSDTST from '@/assets/imgs/tsdt_p1_str.webp';

const RAW_NEWS_DATA: Array<NewsLstData> = [
  {
    id: '1',
    newsTit:
...
export const useNewsLstData = (): { data: Array<NewsLstData> } => {
  const data = useMemo<Array<NewsLstData>>(
    () =>
      RAW_NEWS_DATA.map((item) => ({
        ...item,
        typeTit:
          item.typeTit ?? NEWS_EVENT_CATEGORY_META[item.categories].label,
      })),
    [],
  );
  return { data };
