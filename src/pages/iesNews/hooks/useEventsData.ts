...
import THTN2 from '@/assets/imgs/thtn_p2.webp';
...
export const useEventsData = (): { data: Array<EventsData> } => {
  const data = useMemo<Array<EventsData>>(
    () => [
      {
        id: '1',
...
- Giao lưu, học hỏi từ chuyên gia và các bạn học sinh cùng đam mê lập trình.`,
        img: EVAI,
        decs2: `🚀 **Tầm quan trọng của Workshop**
