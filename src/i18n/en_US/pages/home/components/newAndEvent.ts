export default {
  ...
  elecDesc:
    'Electrical and Electronics Engineering Technology: The Appeal of a Key Industrial Sector',
  autoDesc:
    'Automotive Engineering Technology: A “High-Value” Career with a Promising Future',
  graphicDesc: 'Graphic Design: A Promising Field of Study',
};
