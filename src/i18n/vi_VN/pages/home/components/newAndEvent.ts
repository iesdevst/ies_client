export default {
  ...
  autoEng: 'Kỹ thuật Ô tô',
  graphicD: 'Thiết kế Đồ họa',
  elecDesc:
    'Công nghệ Kỹ thuật Điện & Điện tử: Sức hút của ngành công nghiệp then chốt',
  autoDesc: 'Công nghệ Kỹ thuật Ô tô: Nghề “giá trị cao” với tương lai hứa hẹn',
  graphicDesc: 'Thiết kế Đồ họa: Ngành học đầy triển vọng',
};
